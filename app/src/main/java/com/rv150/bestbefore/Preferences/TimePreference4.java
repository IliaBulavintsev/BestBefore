...
/**
 * Created by Rudnev on 11.11.2016.
 */

public class TimePreference4 extends DialogPreference {
         ...
         * @param attributes
         */
        public TimePreference4(Context context,
        ...
        public void onBindDialogView(View view) {
            ...
            timePicker.setCurrentHour(getSharedPreferences().getInt(Resources.PREF_FOURTH_HOUR, DEFAULT_HOUR));
            timePicker.setCurrentMinute(getSharedPreferences().getInt(Resources.PREF_FOURTH_MINUTE, DEFAULT_MINUTE));
        ...
        protected void onDialogClosed(boolean okToSave) {
            ...
            if (okToSave) {
                ...
                editor.putInt(Resources.PREF_FOURTH_HOUR, hour);
                editor.putInt(Resources.PREF_FOURTH_MINUTE, minute);
                editor.apply();
