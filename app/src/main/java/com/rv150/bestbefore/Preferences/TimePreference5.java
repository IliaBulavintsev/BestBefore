...
public class TimePreference5  extends DialogPreference {
         ...
         * @param attributes
         */
        public TimePreference5(Context context,
        ...
        public void onBindDialogView(View view) {
            ...
            timePicker.setCurrentHour(getSharedPreferences().getInt(Resources.PREF_FIFTH_HOUR, DEFAULT_HOUR));
            timePicker.setCurrentMinute(getSharedPreferences().getInt(Resources.PREF_FIFTH_MINUTE, DEFAULT_MINUTE));
        ...
        protected void onDialogClosed(boolean okToSave) {
            ...
            if (okToSave) {
                ...
                editor.putInt(Resources.PREF_FIFTH_HOUR, hour);
                editor.putInt(Resources.PREF_FIFTH_MINUTE, minute);
                editor.apply();
