...
public class TimePreference3 extends DialogPreference {
    ...
    public void onBindDialogView(View view) {
        ...
        timePicker.setCurrentHour(getSharedPreferences().getInt("third_hour", DEFAULT_HOUR));
        timePicker.setCurrentMinute(getSharedPreferences().getInt("third_minute", DEFAULT_MINUTE));
